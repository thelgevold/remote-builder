...
@NgModule({
  declarations: [Comp],
  imports: [
    Module_airplane_team6_mod0,
    Module_airplane_team6_mod1,
    Module_airplane_team6_mod2,
    Module_airplane_team6_mod3,
    Module_airplane_team6_mod4,
    Module_airplane_team6_mod5,
    Module_airplane_team6_mod6,
    Module_airplane_team6_mod7,
    Module_airplane_team6_mod8,
    Module_airplane_team6_mod9
  ],
  exports: [Comp]
})
