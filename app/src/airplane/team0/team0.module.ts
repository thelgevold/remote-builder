...
@NgModule({
  declarations: [Comp],
  imports: [
    Module_airplane_team0_mod0,
    Module_airplane_team0_mod1,
    Module_airplane_team0_mod2,
    Module_airplane_team0_mod3,
    Module_airplane_team0_mod4,
    Module_airplane_team0_mod5,
    Module_airplane_team0_mod6,
    Module_airplane_team0_mod7,
    Module_airplane_team0_mod8,
    Module_airplane_team0_mod9
  ],
  exports: [Comp]
})
