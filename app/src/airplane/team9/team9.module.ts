...
@NgModule({
  declarations: [Comp],
  imports: [
    Module_airplane_team9_mod0,
    Module_airplane_team9_mod1,
    Module_airplane_team9_mod2,
    Module_airplane_team9_mod3,
    Module_airplane_team9_mod4,
    Module_airplane_team9_mod5,
    Module_airplane_team9_mod6,
    Module_airplane_team9_mod7,
    Module_airplane_team9_mod8,
    Module_airplane_team9_mod9
  ],
  exports: [Comp]
})
