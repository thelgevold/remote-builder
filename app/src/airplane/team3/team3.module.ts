...
@NgModule({
  declarations: [Comp],
  imports: [
    Module_airplane_team3_mod0,
    Module_airplane_team3_mod1,
    Module_airplane_team3_mod2,
    Module_airplane_team3_mod3,
    Module_airplane_team3_mod4,
    Module_airplane_team3_mod5,
    Module_airplane_team3_mod6,
    Module_airplane_team3_mod7,
    Module_airplane_team3_mod8,
    Module_airplane_team3_mod9
  ],
  exports: [Comp]
})
