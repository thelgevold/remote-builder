...
@NgModule({
  declarations: [Comp],
  imports: [
    Module_airplane_team4_mod0,
    Module_airplane_team4_mod1,
    Module_airplane_team4_mod2,
    Module_airplane_team4_mod3,
    Module_airplane_team4_mod4,
    Module_airplane_team4_mod5,
    Module_airplane_team4_mod6,
    Module_airplane_team4_mod7,
    Module_airplane_team4_mod8,
    Module_airplane_team4_mod9
  ],
  exports: [Comp]
})
