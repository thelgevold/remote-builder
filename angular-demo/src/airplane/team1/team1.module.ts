...
@NgModule({
  declarations: [Comp],
  imports: [
    Module_airplane_team1_mod0,
    Module_airplane_team1_mod1,
    Module_airplane_team1_mod2,
    Module_airplane_team1_mod3,
    Module_airplane_team1_mod4,
    Module_airplane_team1_mod5,
    Module_airplane_team1_mod6,
    Module_airplane_team1_mod7,
    Module_airplane_team1_mod8,
    Module_airplane_team1_mod9
  ],
  exports: [Comp]
})
