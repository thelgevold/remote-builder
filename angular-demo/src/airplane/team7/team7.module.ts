...
@NgModule({
  declarations: [Comp],
  imports: [
    Module_airplane_team7_mod0,
    Module_airplane_team7_mod1,
    Module_airplane_team7_mod2,
    Module_airplane_team7_mod3,
    Module_airplane_team7_mod4,
    Module_airplane_team7_mod5,
    Module_airplane_team7_mod6,
    Module_airplane_team7_mod7,
    Module_airplane_team7_mod8,
    Module_airplane_team7_mod9
  ],
  exports: [Comp]
})
