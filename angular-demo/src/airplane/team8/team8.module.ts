...
@NgModule({
  declarations: [Comp],
  imports: [
    Module_airplane_team8_mod0,
    Module_airplane_team8_mod1,
    Module_airplane_team8_mod2,
    Module_airplane_team8_mod3,
    Module_airplane_team8_mod4,
    Module_airplane_team8_mod5,
    Module_airplane_team8_mod6,
    Module_airplane_team8_mod7,
    Module_airplane_team8_mod8,
    Module_airplane_team8_mod9
  ],
  exports: [Comp]
})
