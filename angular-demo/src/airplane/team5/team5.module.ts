...
@NgModule({
  declarations: [Comp],
  imports: [
    Module_airplane_team5_mod0,
    Module_airplane_team5_mod1,
    Module_airplane_team5_mod2,
    Module_airplane_team5_mod3,
    Module_airplane_team5_mod4,
    Module_airplane_team5_mod5,
    Module_airplane_team5_mod6,
    Module_airplane_team5_mod7,
    Module_airplane_team5_mod8,
    Module_airplane_team5_mod9
  ],
  exports: [Comp]
})
