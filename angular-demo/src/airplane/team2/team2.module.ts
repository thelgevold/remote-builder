...
@NgModule({
  declarations: [Comp],
  imports: [
    Module_airplane_team2_mod0,
    Module_airplane_team2_mod1,
    Module_airplane_team2_mod2,
    Module_airplane_team2_mod3,
    Module_airplane_team2_mod4,
    Module_airplane_team2_mod5,
    Module_airplane_team2_mod6,
    Module_airplane_team2_mod7,
    Module_airplane_team2_mod8,
    Module_airplane_team2_mod9
  ],
  exports: [Comp]
})
